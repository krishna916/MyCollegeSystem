    ...
    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
        <div id="remove-scroll" class="left-sidemenu">
            <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="sidebar-user-panel">
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>
                                <c:choose>
                                    <c:when test="${ not empty professorCommand.firstName}" >
                                        ${professorCommand.firstName} ${professorCommand.lastName}
                                    </c:when>
                                    <c:otherwise>
                                        ${professorCommand.userCommand.email}
                                    </c:otherwise>
                                </c:choose>

                            </p>
                            <span>${professorCommand.departmentCommand.departmentName}</span>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item active">
                            <a href="/student/home" class="nav-link ">
                ...
                <li class="nav-item">
                    <a href="${pageContext.request.contextPath}/professor/upload/${user.id}" class="nav-link nav-toggle"> <i class="material-icons">event</i>
                ...
                <li class="nav-item">
                    <c:url var="editProfile" value="${pageContext.request.contextPath}/professor/editProfile/${user.id}" />
                    <a href="${editProfile}" class="nav-link "><i class="fas fa-user-friends"></i>
                        <span class="title">Edit Profile</span><span class="pull-right"><i class="fas fa-angle-right"></i></span></a>
