                                                        ...
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                            ...
                                                            <tr class="odd gradeX">
                                                                <td class="patient-img">
                                                                    <img alt="" class="img-circle " src="data:image/jpeg;base64,${user.userPhoto.image}" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a href="/admin/editStudent/${user.student.id}" class="btn btn-primary btn-xs">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                    <a href="/admin/deleteStudent/${user.id}" class="btn btn-danger btn-xs">
