                ...
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class="row">
                            <div class="col-md-4">
                                <div class=" pull-left">
                                    <div class="page-title">Batch Information</div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item" href="#">All Batches</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">${batchCommand.batchCode}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>${batchCommand.batchCode}</header>
                                                    <div class="tools">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="table-scrollable">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example5">
                                                            ...
                                                            <c:forEach items="${studentCommand}" var="studentCommand" >

                                                                <tr class="odd gradeX">
                                                                    <td class="patient-img">
                                                                        <img alt="" class="img-circle " src="data:image/jpeg;base64,${studentCommand.userCommand.userPhotoCommand.image}" />
                                                                    </td>
                                                                    <td>${studentCommand.firstName}</td>
                                                                    <td>${studentCommand.lastName}</td>
                                                                    <td>${studentCommand.departmentCommand.departmentName}</td>
                                                                    <td>
                                                                        <a href="${pageContext.request.contextPath}/admin/addStudentToBatch/${studentCommand.id}/${batchCommand.id}"
