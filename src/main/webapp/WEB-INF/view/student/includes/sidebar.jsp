    ...
    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
        <div id="remove-scroll" class="left-sidemenu">
            <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="sidebar-user-panel">
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>
                                <c:choose>
                                    <c:when test="${ not empty studentCommand.firstName}" >
                                        ${studentCommand.firstName} ${studentCommand.lastName}
                                    </c:when>
                                    <c:otherwise>
                                        ${user.email}
                                    </c:otherwise>
                ...
                <li class="nav-item">
                    <a href="/student/upload/${user.id}" class="nav-link nav-toggle"> <i class="material-icons">event</i>
                ...
                <li class="nav-item">
                    <c:url var="editProfile" value="${pageContext.request.contextPath}/student/editProfile/${user.id}" />
